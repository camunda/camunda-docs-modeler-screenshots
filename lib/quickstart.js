...
module.exports = async function startScreenshotBatch() {
  ...
  promises.push(triggerScreenshot(
    ...
    async (filepath) => {
      ...
      await modeler.annotate('textarea[name="name"]', 'Set <b>Process Name</b>', annotationOptions.left);
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway1.png',
    async (filepath) => {
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway2.png',
    async (filepath) => {
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway3.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step3.2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/large_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway4.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step3.2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway5.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step3.2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-gateway6.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step3.2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-businessrule-task1.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step3.2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-businessrule-task2.png',
    async (filepath) => {
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-new-dmn-diagram-properties.png',
    async (filepath) => {
  ...
  /* promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-new-dmn-diagram.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/quickstart/step4.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-new-dmn-table.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/dmn/quickstart/step4.2.dmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-dmn2.png',
    async (filepath) => {
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-dmn4.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/dmn/quickstart/step4.2.dmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-dmn5.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/dmn/quickstart/step4.2.dmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  promises.push(triggerScreenshot('camunda-docs-static/get-started/content/quick-start/img/modeler-dmn6.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/dmn/quickstart/step4.2.dmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
