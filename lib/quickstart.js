...
module.exports = async function startScreenshotBatch() {
  ...
  await triggerScreenshot(
    ...
    async (filepath) => {
      ...
      await modeler.annotate('[data-entry="id"]', 'Set <b>Process ID</b>', annotationOptions.left);
      await modeler.annotate('[data-entry="name"]', 'Set <b>Process Name</b>', annotationOptions.left);
      await modeler.annotate('[data-entry="process-is-executable"]', 'Mark the process to be <b>executable</b>', annotationOptions.left);
