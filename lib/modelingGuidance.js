...
module.exports = async function startScreenshotBatch() {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/called-element/wrong.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/called-element/right.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/element-type/wrong.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/element-type/right.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/error-reference/wrong-no-error-reference.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/error-reference/wrong-no-error-code.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/error-reference/right.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/escalation-reference/wrong-no-escalation-reference.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/escalation-reference/wrong-no-escalation-code.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/escalation-reference/right.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/feel/wrong.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/feel/right.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/message-reference/wrong-no-message-reference.png', async (filepath) => {
  ...
  await triggerScreenshot('camunda-platform-docs/docs/components/modeler/reference/rules/img/message-reference/right.png', async (filepath) => {
