...
class Modeler {
  ...
  async setCodeMirrorValue(selector, value) {
    const editorHandle = await this.getElement(selector);

    await editorHandle.evaluate((editorDOM, value) => {
      // eslint-disable-next-line no-undef
      const view = window.EditorView.findFromDOM(editorDOM);
