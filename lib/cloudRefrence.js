...
module.exports = async function startScreenshotBatch(displayVersion) {
  ...
  promises.push(triggerScreenshot(
    'camunda-platform-docs/docs/components/modeler/desktop-modeler/element-templates/img/field-dropdown.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json'),
            templates = [path.join(__dirname, './fixtures/element-templates/rest-connector.json')];
  ...
  promises.push(triggerScreenshot(
    'camunda-platform-docs/docs/components/modeler/desktop-modeler/element-templates/img/groups.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json'),
  ...
  promises.push(triggerScreenshot(
    'camunda-platform-docs/docs/components/modeler/desktop-modeler/element-templates/img/icons.png',
    async (filepath) => {
  ...
  promises.push(triggerScreenshot(
    'camunda-platform-docs/docs/components/modeler/desktop-modeler/element-templates/img/entries-visible.png',
    async (filepath) => {
