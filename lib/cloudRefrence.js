...
const OAUTH_URL = process.env.OAUTH_URL || 'addMe';
...
module.exports = async function startScreenshotBatch(displayVersion) {
  ...
  // self-managed
  await triggerScreenshot(
    'camunda-cloud-documentation/docs/self-managed/modeler/desktop-modeler/img/deploy-icon.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  await triggerScreenshot(
    'camunda-cloud-documentation/docs/self-managed/modeler/desktop-modeler/img/deploy-empty.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  await triggerScreenshot(
    'camunda-cloud-documentation/docs/self-managed/modeler/desktop-modeler/img/deploy-endpoint.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  await triggerScreenshot(
    'camunda-cloud-documentation/docs/self-managed/modeler/desktop-modeler/img/deploy-with-oauth.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
  ...
  await triggerScreenshot(
    'camunda-cloud-documentation/docs/self-managed/modeler/desktop-modeler/img/deploy-success.png',
    async (filepath) => {
      const diagramPaths = [ path.join(__dirname, './fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
            config = path.join(__dirname, './fixtures/user-data/quickstart_with_prop_panel.json');
