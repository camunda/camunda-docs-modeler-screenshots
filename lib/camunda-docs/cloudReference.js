...
/**
 * Generate screenshots for a specific documentation version.
...
function generateScreenshotsForVersion(versionPath, c8EngineVersion) {
  ...
  return [
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/empty.png`,
      async (filepath) => {
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/new-diagram.png`,
      async (filepath) => {
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/elements.png`,
      async (filepath) => {
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/element-configuration.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/properties-panel.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/deploy-icon.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
...

    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/deploy-diagram-camunda-cloud.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/deploy-diagram-camunda-cloud-success.png`,
        async (filepath) => {
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/deploy-diagram-camunda-cloud-remember.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/start-instance-icon.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/start-instance-step-1.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/start-instance-step-2.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/start-instance-successful.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    // self-managed
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-icon.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-empty.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram2.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-endpoint.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-with-basic-auth.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-with-oauth.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/self-managed/components/modeler/desktop-modeler/img/deploy-success.png`,
        async (filepath) => {
          const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/diagram3.bpmn') ],
                config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json');
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/process-applications/overlay.png`,
      async (filepath) => {
        ...
        const modeler = await createModeler({ diagramPaths, processApplicationPaths, configPath: config, c8EngineVersion });
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/process-applications/grouping.png`,
      async (filepath) => {
        const diagramPaths = [
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/process-applications/link-resources.png`,
      async (filepath) => {
        const diagramPaths = [
                path.join(__dirname, '../fixtures/process-applications/credit-score-calculation.dmn'),
                path.join(__dirname, '../fixtures/process-applications/interest-rate-calculation.dmn'),
    ...
    // element templates //////////////////////
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/element-templates/img/overview.png`,
      async (filepath) => {
        ...
        const modeler = await createModeler({ diagramPaths, configPath: config, c8EngineVersion, elementTemplatePaths: templates });
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/element-templates/img/chooser.png`,
      async (filepath) => {
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/element-templates/img/modal.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/chooser.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [ path.join(__dirname, '../fixtures/element-templates/all-templates.json') ];
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/element-templates/img/unlink-remove.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [ path.join(__dirname, '../fixtures/element-templates/rest-connector.json') ];
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/element-templates/img/update-template.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/desktop-modeler/element-templates/img/template-not-found.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [ ];
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/element-templates/img/field-dropdown.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [ path.join(__dirname, '../fixtures/element-templates/rest-connector.json') ];
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/element-templates/img/groups.png`,
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/element-templates/img/icons.png`,
      async (filepath) => {
    ...
    () => triggerScreenshot(
      `camunda-docs/${versionPath}/components/modeler/element-templates/img/entries-visible.png`,
      async (filepath) => {
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/task-testing/testing-tab.png`,
        async (filepath) => {
          ...
          const modeler = await createModeler({ diagramPaths, configPath, c8EngineVersion });
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/task-testing/testing-success.png`,
        async (filepath) => {
          ...
          const modeler = await createModeler({ diagramPaths: [ diagramPath ], configPath, additionalConfig, c8EngineVersion });
    ...
    {
      skip: () => triggerScreenshot(
        `camunda-docs/${versionPath}/components/modeler/desktop-modeler/img/task-testing/testing-incident.png`,
        async (filepath) => {
          const diagramPath = path.join(__dirname, '../fixtures/bpmn/cloud-reference/task-testing.bpmn');
          const configPath = path.join(__dirname, '../fixtures/user-data/bottom_panel.json');
          const additionalConfig = {
...
/**
 * Main export function that generates screenshots for all configured documentation versions.
 * If c8EngineVersion is provided, uses it for all versions (backward compatibility).
 * Otherwise, generates screenshots for each configured version with its appropriate engine version.
 */
module.exports = function startScreenshotBatch(c8EngineVersion) {

  // If a specific engine version is provided, use the old behavior (single version)
  if (c8EngineVersion) {
    return generateScreenshotsForVersion('docs', c8EngineVersion);
  }

  // Otherwise, generate screenshots for all configured versions
  const tasks = [];
