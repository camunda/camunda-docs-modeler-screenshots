  ...
  return [
    ...
    () => triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.click('[data-element-id="ServiceTask_1"]');
        await modeler.getElement('.bio-properties-panel-select-template-button, button[title="Select a template"]');
        await modeler.click('.bio-properties-panel-select-template-button, button[title="Select a template"]');
