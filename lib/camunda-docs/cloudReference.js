  ...
  return [
    ...
    () => triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.getElement('.bio-properties-panel-select-template-button');
    ...
    () => triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.click('[data-element-id="ServiceTask_1"]');
        await modeler.getElement('.bio-properties-panel-select-template-button');
        await modeler.click('.bio-properties-panel-select-template-button');
    ...
    () => triggerScreenshot(
      'camunda-docs/docs/components/modeler/element-templates/img/field-configuration.png',
      async (filepath) => {
        const diagramPaths = [ path.join(__dirname, '../fixtures/bpmn/cloud-reference/element-templates/overview.bpmn') ],
              config = path.join(__dirname, '../fixtures/user-data/quickstart_with_prop_panel.json'),
              templates = [ path.join(__dirname, '../fixtures/element-templates/rest-connector.json') ];
        ...
        await modeler.click('[data-element-id="ServiceTask_1"]');
        await modeler.annotate('[data-entry-id="custom-entry-io.camunda.connectors.RestConnector-s1-2"]', 'Configuration chooser');
    ...
    () => triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.click('[data-element-id="ServiceTask_1"]');
        await modeler.annotate('[data-entry-id="custom-entry-io.camunda.connectors.RestConnector-s1-4"]', 'Dropdown');
    ...
    () => triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.getElement('.bio-properties-panel-group-header-title >> "Endpoint"');
    ...
    ()=> triggerScreenshot(
      ...
      async (filepath) => {
        ...
        await modeler.click(CONNECTION_SELECTOR_BUTTON_SELECTOR);
        await modeler.getElement('select#connection >> text="New connection 3"');
